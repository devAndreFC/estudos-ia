        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    "ticker": {
                        "type": "string",
                        "description": "O ticker da ação. Ex: BBAS3, ITSA4, etc",
                    },
                    "periodo": {
                        "type": "string",
                        "description": "Período dos dados históricos: '1d', '5d', '1mo', etc.",
                        "enum": [
                            "1d",
                            "5d",
                            "1mo",
...
def gera_texto(mensagens):
    resposta = client.chat.completions.create(
        messages=mensagens, model="gpt-3.5-turbo-0125", tools=tools, tool_choice="auto"
    )
